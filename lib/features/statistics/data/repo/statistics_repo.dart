...
class StatisticsRepo {
  ...
  StatisticsRepo({required this.apiService});

  Future<ApiResult<AgentActionStatisticsResponse>>
  getAgentActionStatistics() async {
    try {
      final response = await apiService.getAgentActionStatistics();
