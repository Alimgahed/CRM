...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  initial,TResult Function()?  loading,TResult Function( List<Role> data)?  loaded,TResult Function( String message)?  error,required TResult orElse(),}) {final _that = this;
switch (_that) {
case Initial() when initial != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  initial,required TResult Function()  loading,required TResult Function( List<Role> data)  loaded,required TResult Function( String message)  error,}) {final _that = this;
switch (_that) {
case Initial():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  initial,TResult? Function()?  loading,TResult? Function( List<Role> data)?  loaded,TResult? Function( String message)?  error,}) {final _that = this;
switch (_that) {
case Initial() when initial != null:
return initial();case Loading() when loading != null:
return loading();case Loaded() when loaded != null:
...
class Initial implements RolesState {
  const Initial();
...
class Loading implements RolesState {
  const Loading();
...
class Loaded implements RolesState {
  const Loaded(final  List<Role> data): _data = data;
...
@override
String toString() {
  return 'RolesState.loaded(data: $data)';
}
...
/// @nodoc
abstract mixin class $LoadedCopyWith<$Res> implements $RolesStateCopyWith<$Res> {
...
class _Error implements RolesState {
...
@override
String toString() {
  return 'RolesState.error(message: $message)';
}
...
/// @nodoc
abstract mixin class _$ErrorCopyWith<$Res> implements $RolesStateCopyWith<$Res> {
